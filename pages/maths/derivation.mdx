...
| $x^n$    | $nx^{n-1}$ |
<br />
Nous, on va surtout retenir $x^n = nx^{n-1}$
<br />
...
<div class="p-4 font-mono border-l-2 border-orange bg-mbg my-6">
$$
f(x) = 5x^3
$$
$$
...
$$
$$
f'(x) = 2*3x^{2-1} + 4*\frac{1}{2\sqrt{x}}
$$
</div>
<div class="p-4 font-mono border-l-2 border-orange bg-mbg my-6">
$$
...
$$
$$
f'(x) = (2*3x^{2-1} + 4)(6x - 1) + (3x^2 + 4x)(6)
$$
$$
f'(x) = (6x + 4)(6x - 1) + (3x^2 + 4x)(6)
$$
$$
f'(x) = 36x^2 - 6x + 24x - 4 + 18x^2 + 24x
$$
$$
f'(x) = 54x^2 + 42x - 4
$$
...
$$
$$
f'(x) = (2*3x^{2-1} - 0)\sqrt{x} + (3x^2 - 1)\frac{1}{2\sqrt{x}}
$$
$$
f'(x) = 6x\sqrt{x} + \frac{3x^2 - 1}{2\sqrt{x}}
$$
</div>
<div class="p-4 font-mono border-l-2 border-orange bg-mbg my-6">
$$
...
<div class="p-4 font-mono border-l-2 border-orange bg-mbg my-6">
$$
f(x) = \frac{6x-5}{x^3-2x^2+1}
$$
$$
f(x) = \frac{6(x^3-2x+1)-(6x-5)(3x^2-4x)}{(x^3-2x^2+1)^2}
$$
</div>
