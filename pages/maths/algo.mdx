...
<br />
## Exercice:
### 1. On definit la suite de fibonacci la suite de reels (Fn) définie par:
$$
F_0 = 0
$$
$$
...
```
### 2. Ecrire un algorithme qui demande un nombre de départ, et qui calcule la somme des entiers jusqu'à ce nombre.
```
