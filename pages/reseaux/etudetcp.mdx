...
<br />
<br />
**Le protocole Ethernet**Le champ FCS (Frame Check Sequence) codé sur 4 octets qui permet de valider l'intégrité de la trame à 1 bit
...
<br />
<br />
<p className="text-red">A partir d'ici, pendant les vacances, lire les pages du diapo 41 a 59</p>