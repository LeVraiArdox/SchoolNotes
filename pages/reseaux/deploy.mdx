---
type: page
title: A quelle echelle sont ils deployés ?
tag: Réseaux
author: Ardox
---
...
Dans cette partie, nous allons voir différentes échelles de réseau. Noter que pour certains types de réseaux, vous
ne serez que très rarement, voire jamais confrontés durant votre carrière. Cependant, il est essentiel de les
...
ou sans fil. A noter qu’un PAN n’est pas forcément connecté à Internet.
<Diagram src="/reseaux/pan.png" />
<br />
## 4. LAN{" "}
