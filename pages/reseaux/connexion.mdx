---
type: page
title: Comment ces équipements sont-ils connectés entre eux ?
tag: Réseaux
author: Ardox
---
...
# Comment ces équipements sont-ils connectés entre eux ?
<br />
...
types de câble.
<br />
<Diagram src="/reseaux/tableau_torsade.png" />
<br />
...
norme de câblage T568B.<Diagram src="/reseaux/cable_droit.png" />
<br />
...
contrôleur d’interface réseau) ou deux commutateurs l’un à l’autre.<Diagram src="/reseaux/cable_croise.png" />
<br />
...
<br />
<Diagram src="/reseaux/poetab.png" />
<br />
<br />
### 2. La Fibre Optique
...
Un seul mode de propagation de la lumière existe : c'est le mode en ligne droite. <Diagram src="/reseaux/monomode.png" /> 
...
C'est pour cela que les rayons lumineux se propagent par réflexion totale interne en "dent de scie". <Diagram src="/reseaux/multimode.png" />
...
rayons lumineux qui ont une forme elliptique. <Diagram src="/reseaux/multimode2.png" />
...
- - Affaiblissement : 10 dB/Km
<br />
<Diagram src="/reseaux/fibretable.png" />
<br />
...
<br />
<Diagram src="/reseaux/wifi.png" />
<Diagram src="/reseaux/wifitable.png" />
<br />
<div className="seperator" />
...
débit offert.
<br />
<Diagram src="/reseaux/cpl.png" />
<Diagram src="/reseaux/cpltable.png" />
<br />
<div className="seperator" />